...
class GetAllExpenses {
    ...
    factory GetAllExpenses.fromRawJson(String str) => GetAllExpenses.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory GetAllExpenses.fromJson(Map<String, dynamic> json) => GetAllExpenses(
